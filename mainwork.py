...
MAIL_NAME_CODE = '0c'   # Initial login uniqueness value
...
#options.add_argument(f'user-agent=Mozilla/5.0 (Linux; Android 4.1.1; GT-N7100 Build/JRO03C) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/35.0.1916.138 Mobile Safari/537.36 T7/6.3')
...
for i in range(300):
    try:
        mailCodeName = MAIL_NAME_CODE + str(i)
